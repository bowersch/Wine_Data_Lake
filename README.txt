For more information about this product, visit: https://winedatalake.com/info
...
Installations 
        PgAdmin (for PostgreSQL):   https://www.pgadmin.org/download/ 
   ...
   * After cloning the repo:
      * For database: in pgAdmin (with full permissions)
         ...
         * Right click on the database name, select Query Tool
            * Add code from wdl_tables.sql and run the query to add the tables
            * Add code from wdl_data.sql and run the query to add some data
