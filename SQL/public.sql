...
;
COMMENT ON TABLE "public"."ava_data" IS 'ava_data_葡萄种植区';
...
;
COMMENT ON TABLE "public"."bottle_data" IS 'bottle_data_酒数据';
...
;
COMMENT ON TABLE "public"."terminology_data" IS 'terminology_data_术语';
...
COMMENT ON TABLE "public"."user_favorite" IS 'user_favorite用户收藏';
...
;
COMMENT ON TABLE "public"."users" IS 'users_用户数据';

-- ----------------------------
-- Records of users
-- ----------------------------
INSERT INTO "public"."users" VALUES (1, 'leroyjenkins', 35, NULL, '1312345678', NULL, NULL, NULL);
INSERT INTO "public"."users" VALUES (2, '刘先生', 43, NULL, NULL, NULL, NULL, NULL);
INSERT INTO "public"."users" VALUES (3, '赵龙川', 28, NULL, NULL, NULL, NULL, NULL);
INSERT INTO "public"."users" VALUES (4, '郭靖', 50, NULL, NULL, NULL, NULL, NULL);
INSERT INTO "public"."users" VALUES (5, '安欣', 33, NULL, NULL, NULL, NULL, NULL);
INSERT INTO "public"."users" VALUES (6, '默哥', 34, '杀鱼的', NULL, NULL, NULL, NULL);
INSERT INTO "public"."users" VALUES (7, '陈舒婷', 28, NULL, NULL, NULL, NULL, NULL);
INSERT INTO "public"."users" VALUES (8, '唐小龙', 45, NULL, NULL, NULL, NULL, NULL);
INSERT INTO "public"."users" VALUES (9, '高启强', 46, NULL, NULL, NULL, NULL, NULL);
...
;
COMMENT ON TABLE "public"."varietal_data" IS 'varietal_data_品种数据';
...
;
COMMENT ON TABLE "public"."winery_data" IS 'winery_data_酿酒厂数据';
